#include "edu_uw_apl_commons_devicefiles_DeviceFile.h"
...
/*
 * Class:     edu_uw_apl_commons_devicefiles_DeviceFile
 * Method:    size
 * Signature: (Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL 
Java_edu_uw_apl_commons_devicefiles_DeviceFile_size
...
Java_edu_uw_apl_commons_devicefiles_DeviceFile_vendorID
(JNIEnv *env, jobject thiz, jstring path ) {
 ...
 */
JNIEXPORT jstring JNICALL 
Java_edu_uw_apl_commons_devicefiles_DeviceFile_productID
(JNIEnv *env, jobject thiz, jstring path ) {
 ...
 */
JNIEXPORT jstring JNICALL 
Java_edu_uw_apl_commons_devicefiles_DeviceFile_serialNumber
(JNIEnv *env, jobject thiz, jstring path ) {
